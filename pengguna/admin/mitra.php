...
<body translate="no">
    ...
    <main id="main" class="main">
        ...
        <div id="load_data">
            ...
            // Query untuk mendapatkan data mitra dengan pencarian dan pagination
            $query = "SELECT * FROM mitra WHERE nama_lengkap LIKE ? OR nomor_hp LIKE ? LIMIT ?, ?";
            ...
            $total_query = "SELECT COUNT(*) as total FROM mitra WHERE nama_lengkap LIKE ? OR nomor_hp LIKE ?";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-success btn-sm" data-bs-toggle="tooltip"
                                                                data-bs-placement="bottom" title="Klik untuk menyalin nomor HP"
                                                                onclick="copyToClipboard(this, '<?php echo htmlspecialchars($row['nomor_hp']); ?>')">
                                                                <?php echo htmlspecialchars($row['nomor_hp']); ?>
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-success btn-sm" data-bs-toggle="tooltip"
                                                        ...
                                                        <td>
                                                            <button class=" btn btn-warning btn-sm"
                                                                onclick="openEditModal('<?php echo $row['id_mitra']; ?>','<?php echo $row['nama_lengkap']; ?>','<?php echo $row['nomor_hp']; ?>','<?php echo $row['password']; ?>')">Edit</button>
                                                            <button class="btn btn-danger btn-sm"
                                                                onclick="hapus('<?php echo $row['id_mitra']; ?>')">Hapus</button>
                                                        </td>
                                                    </tr>
                                                <?php endwhile; ?>
                                            </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="tambahForm" method="POST" action="proses/mitra/tambah.php"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="nomor_hp" name="nomor_hp" class="form-control" min="0"
                                    required>
                            </div>
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editDataModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" action="proses/mitra/redit.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="nomor_hp" class="form-label">Nomor Hp</label>
                                <input type="number" id="edit-nomor_hp" name="nomor_hp" class="form-control" min="0"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                document.getElementById('tambahForm').addEventListener('submit', function(event) {
                    ...
                    xhr.open('POST', 'proses/mitra/tambah.php', true);
                    xhr.onload = function() {
                        if (xhr.status === 200) {
            ...
            function openEditModal(id_mitra, nama_lengkap, nomor_hp, password) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                document.getElementById('editForm').addEventListener('submit', function(event) {
                    ...
                    var xhr = new XMLHttpRequest();
                    xhr.open('POST', 'proses/mitra/edit.php', true);
                    xhr.onload = function() {
                        if (xhr.status === 200) {
                            var response = xhr.responseText.trim();
                            console.log(response); // Debugging
            ...
            function hapus(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        xhr.open('POST', 'proses/mitra/hapus.php', true);
            ...
            function loadTable() {
                ...
                xhrTable.open('GET', 'proses/mitra/load_data.php?page=' + currentPage + '&search=' + encodeURIComponent(
                    searchQuery), true);
                xhrTable.send();
            }
        </script>
