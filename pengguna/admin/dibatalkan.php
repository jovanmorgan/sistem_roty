...
<body translate="no">
    ...
    <main id="main" class="main">
        ...
        <div id="load_data">
                                ...
                                <form method="GET" action="">
                                    <div class="input-group mt-3">
                                        <input type="text" class="form-control"
                                            placeholder="Cari dibatalkan atau nomor rekening..." name="search"
            ...
            <?php
            // Ambil data dibatalkan dari database
          ...
          LIMIT ?, ?";
                                                ...
                                                ?>
                                                    ...
                                                    <?php if (!empty($row['bukti_pengiriman'])): ?>
                                                        <div class="modal fade" id="modalGambar<?php echo $row['id_dibatalkan']; ?>"
                                                            tabindex="-1"
                                                            aria-labelledby="modalLabel<?php echo $row['id_dibatalkan']; ?>"
                                                            aria-hidden="true">
            ...
            <script>
                ...
                function lihatDetail(nomor_pemesanan) {
                    window.location.href = 'dibatalkan_detail.php?nomor_pemesanan=' + nomor_pemesanan;
                }
            </script>
                ...
                document.getElementById('dibatalkanForm').addEventListener('submit', function(event) {
                    ...
                    xhr.onload = function() {
                        if (xhr.status === 200) {
                            ...
                            } else if (response === 'dibatalkan_sudah_ada') {
                                Swal.fire({
                                    title: "Error",
                                    text: "Data dibatalkan sudah dipromosikan, silakan pilih data roti lainnya",
                                    icon: "info",
                                    timer: 2000, // 2 detik
