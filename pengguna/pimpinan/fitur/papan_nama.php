        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <?php
                    } else if ($page_title === "Check Out") {
                    ?>
                    <a href="export/chack_out.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    } else if ($page_title === "Belum Bayar") {
                    ?>
                    <a href="export/belum_bayar.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    } else if ($page_title === "Dikemas") {
                    ?>
                    <a href="export/dikemas.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    } else if ($page_title === "Dikirim") {
                    ?>
                    <a href="export/dikirim.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    } else if ($page_title === "Diterima") {
                    ?>
                    <a href="export/diterima.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    } else if ($page_title === "Dibatalkan") {
                    ?>
                    <a href="export/dibatalkan.php" type="button" class="btn btn-primary text-white"
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
                    ...
                    <a href="export/pemesanan.php?nomor_pemesanan=<?= $_GET['nomor_pemesanan'] ?>" type="button"
                        class="btn btn-primary text-white" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        title="Klik untuk export" target="_blank">
                        Export
                    </a>
                    <?php
