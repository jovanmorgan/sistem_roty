...
$select_query = "SELECT fp FROM pimpinan WHERE id_pimpinan = '$id_pimpinan'";
...
// Update nama gambar di tabel pimpinan berdasarkan id_pimpinan
$update_query = "UPDATE pimpinan SET fp = '$filename' WHERE id_pimpinan = '$id_pimpinan'";
