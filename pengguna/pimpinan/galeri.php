    ...
    <main id="main" class="main">
                    ...
                    <div class="modal-body">
                        <form id="tambahForm" method="POST" action="proses/galeri/tambah.php"
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file d-none" id="kover" name="gambar_galeri"
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" action="proses/bank/edit.php" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="ri-file-text-line"></i></span>
                                    <textarea class="form-control" id="edit-deskripsi" name="deskripsi" rows="3"
                                        required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file d-none" id="editKover" name="gambar_galeri"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('tambahForm').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'proses/galeri/tambah.php', true);
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            Swal.fire({
                                title: "Error",
                                text: "Jenis file tidak valid, silakan unggah file dengan format yang diperbolehkan.",
                                icon: "warning",
                                timer: 2000, // 2 detik
                                showConfirmButton: false,
                            });
        ...
        function openEditModal(id_galeri, nama, jenis, deskripsi, gambar_galeri) {
        ...
        document.getElementById('editForm').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'proses/galeri/edit.php', true);
            xhr.onload = function() {
                if (xhr.status === 200) {
                    var response = xhr.responseText.trim();
                    console.log(response); // Debugging
        ...
        function hapus(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    xhr.open('POST', 'proses/galeri/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'proses/galeri/load_data.php?page=' + currentPage + '&search=' + encodeURIComponent(
                searchQuery), true);
            xhrTable.send();
        }
        </script>
