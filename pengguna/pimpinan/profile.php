                        ...
                        <div class="card">
                            ...
                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                <a href="javascript:void(0)"
                                    ...
                                    <img src="../../assets/img/fp_pengguna/pimpinan/<?php echo $pimpinan['fp']; ?>"
                                ...
                                <h2 class="text-center"><?php echo $pimpinan['nama_lengkap']; ?></h2>
                                <h3 class="text-center mt-2"><?php echo $pimpinan['nomor_pengguna']; ?></h3>
                            </div>
                        </div>
                    </div>
                    <style>
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $pimpinan['nama_lengkap']; ?>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Nomor Pengguna</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $pimpinan['nomor_pengguna']; ?>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Passweord</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $pimpinan['password']; ?></div>
                                        </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nama_lengkap" type="text" class="form-control"
                                                        id="nama_lengkap"
                                                        value="<?php echo $pimpinan['nama_lengkap']; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nomor_pengguna" type="text" class="form-control"
                                                        id="nomor_pengguna"
                                                        value="<?php echo $pimpinan['nomor_pengguna']; ?>" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="password"
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="password" type="text" class="form-control"
                                                        id="password" value="<?php echo $pimpinan['password']; ?>" />
                                                </div>
                                            </div>
