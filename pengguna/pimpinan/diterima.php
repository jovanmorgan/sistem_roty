...
<body translate="no">
    ...
    <main id="main" class="main">
        ...
        <div id="load_data">
                                ...
                                <form method="GET" action="">
                                    <div class="input-group mt-3">
                                        <input type="text" class="form-control"
                                            placeholder="Cari diterima atau nomor rekening..." name="search"
            ...
            <?php
            // Ambil data diterima dari database
            ...
            // Query untuk mendapatkan data diterima dengan nama mitra dan urutan terbaru
            $query = "SELECT c.*, m.nama_lengkap 
          FROM diterima c 
          LEFT JOIN mitra m ON c.id_mitra = m.id_mitra 
          WHERE status = 'sudah_diterima' AND (m.nama_lengkap LIKE ? OR c.nomor_pemesanan LIKE ?) 
          ORDER BY c.id_diterima DESC 
          LIMIT ?, ?";
                                        ...
                                        <table class="table table-hover text-center mt-3"
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        <td>
                                                            <?php if (!empty($row['bukti_pengiriman'])): ?>
                                                                <img src="../../assets/img/bukti_pengiriman/<?php echo htmlspecialchars($row['bukti_pengiriman']); ?>"
                                                                    ...
                                                                    data-bs-target="#modalGambar<?php echo $row['id_diterima']; ?>" />
                                                            <?php else: ?>
                                                    ...
                                                    <!-- Modal membatalkan  -->
                                                    <div class="modal fade" id="batalkan<?php echo $row['id_diterima']; ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="dibatalkanForm" method="POST"
                                                                        action="proses/diterima/tambah.php"
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="diterima" class="form-label">Alasan
                                                                                Membatalkan</label>
                                                    ...
                                                    <?php if (!empty($row['bukti_pengiriman'])): ?>
                                                        <div class="modal fade" id="modalGambar<?php echo $row['id_diterima']; ?>"
                                                            tabindex="-1"
                                                            aria-labelledby="modalLabel<?php echo $row['id_diterima']; ?>"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            id="modalLabel<?php echo $row['id_diterima']; ?>">Bukti
                                                                            Pembayaran</h5>
                                                                        <button type="button" class="btn-close"
            ...
            <script>
                ...
                function lihatDetail(nomor_pemesanan) {
                    window.location.href = 'diterima_detail.php?nomor_pemesanan=' + nomor_pemesanan;
                }
            </script>
                ...
                document.getElementById('dibatalkanForm').addEventListener('submit', function(event) {
                    ...
                    xhr.onload = function() {
                        if (xhr.status === 200) {
                            ...
                            } else if (response === 'diterima_sudah_ada') {
                                Swal.fire({
                                    title: "Error",
                                    text: "Data diterima sudah dipromosikan, silakan pilih data roti lainnya",
                                    icon: "info",
                                    timer: 2000, // 2 detik
