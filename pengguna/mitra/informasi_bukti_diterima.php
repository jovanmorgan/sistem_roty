...
<body translate="no">
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="diterima" class="nav__logo"><i class="bx bx-arrow-back"
        ...
        <div class="search-popup" id="searchPopup">
            <div class="search-popup-content p-4 rounded shadow-lg">
                <div class="popup-header d-flex justify-content-between align-items-center mb-3">
                    <h3 class="mb-0 text-center">Bukti Pengiriman</h3>
                    <a href="#" class="close-btn" onclick="closeSearchPopup()">
                        <i class="bx bx-x fs-3 mt-3"></i>
                    </a>
                </div>
                <div class="popup-body">
                    <img src="../../assets/img/bukti_pengiriman/<?php echo $bukti_pengiriman; ?>" alt="Bukti Pengiriman"
                        width="100%" />
                </div>
            </div>
        </div>
