<head>
    ...
    <link href="css/nav_icon.css?v=<?= time(); ?>" rel="stylesheet" />
    <link href="css/pesanan_saya.css?v=<?= time(); ?>" rel="stylesheet" />
    <link href="css/status_pengiriman.css?v=<?= time(); ?>" rel="stylesheet" />
    <title>PESANAN SAYA | Fasya Bakery</title>
</head>