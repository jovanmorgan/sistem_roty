...
<body translate="no">
        ...
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="roti" class="nav__link active-link">
            ...
            // Ambil id_mitra dari session (atau sesuaikan jika menggunakan metode lain)
            $id_mitra = $_SESSION['id_mitra'];

            // Menghitung jumlah data dari tabel keranjang berdasarkan id_mitra
            ...
            function sendUpdateRequest(status, id_mitra) {
            ...
            function keranjang_btn() {
                var id_mitra = '<?php echo $id_mitra; ?>'; // Ganti dengan nilai id_mitra yang sesuai
            ...
            <div class="row align-items-start">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        $id_roti = $row['id_roti']; // Pastikan ada kolom id_roti
            ...
            <form id="buyForm">
                ...
                <div class="button-container">
                    <button type="button" class="cart-button" style="background-color: #737373;"
                        id="masukan_kekeranjang">Masukan Kekeranjang</button>
                    <button type="button" class="buy-button" id="beli_sekarang">Beli Sekarang</button>
                </div>
            </form>
        </div>
    </div>
    ...
    function openBuyPopup(namaRoti, hargaRoti, stokRoti, gambarRoti, deskripsiRoti, rasaRoti, nomorSejenis, id) {
        ...
        fetch(`proses/roti/get_roti.php?nomor_sejenis=${nomorSejenis}`)
            .then(response => {
                if (!response.ok) {
    ...
    function loadKeranjang() {
        ...
        // Send request with current page and search query
        xhrTable.open('GET', 'proses/roti/load_keranjang.php');
        xhrTable.send();
    }
    </script>
