...
<body translate="no" translate="no">
    ...
    <form id="form_keranjang" action="proses/keranjang/tambah.php" method="post">
        <header class="header" id="header">
            <nav class="nav container">
                <a href="roti" class="nav__logo"><i class="bx bx-arrow-back"
                        style="font-size: 2.3em; position: relative; left: 15px;"></i>
                </a>
                <a href="roti" class="nav__logo">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Fungsi untuk hapus semua produk yang dipilih
            window.hapusSemuaProduk = function() {
                ...
                if (selectedProducts.length > 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            xhr.open('POST', 'proses/keranjang/hapus_produk.php', true);
                            xhr.onload = function() {
                                if (xhr.status === 200) {
                    ...
                    Swal.fire({
                        ...
                        text: 'Pilih produk yang ingin Anda hapus!',
                        timer: 2000,
                        showConfirmButton: false
                    });
                }
