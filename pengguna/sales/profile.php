                                        ...
                                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                            <a href="javascript:void(0)"
                                                ...
                                                <?php if (!empty($sales['fp'])): ?>
                                                    <img src="../../assets/img/fp_pengguna/sales/<?php echo $sales['fp']; ?>"
                                            ...
                                            <h2 class="text-center"><?php echo $sales['nama_lengkap']; ?></h2>
                                            <h3 class="text-center mt-2"><?php echo $sales['nomor_pengguna']; ?></h3>
                                        </div>
                        </div>
                    </div>
                    <style>
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-8"><?php echo $sales['nama_lengkap']; ?>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Nomor Pengguna</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $sales['nomor_pengguna']; ?>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-lg-3 col-md-4 label">Passweord</div>
                                            <div class="col-lg-9 col-md-8"><?php echo $sales['password']; ?></div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                        ...
                                        <form id="editProfileForm">
                                            <input type="text" name="id_sales" id="id_sales"
                                                value="<?php echo $sales['id_sales']; ?>" hidden>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nama_lengkap" type="text" class="form-control"
                                                        id="nama_lengkap"
                                                        value="<?php echo $sales['nama_lengkap']; ?>" />
                                                </div>
                                            </div>

                                            <div class="row mb-3">
                                                <label for="nomor_pengguna"
                                                    class="col-md-4 col-lg-3 col-form-label">Nomor Pengguna</label>
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="nomor_pengguna" type="text" class="form-control"
                                                        id="nomor_pengguna"
                                                        value="<?php echo $sales['nomor_pengguna']; ?>" />
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="password"
                                                ...
                                                <div class="col-md-8 col-lg-9">
                                                    <input name="password" type="text" class="form-control"
                                                        id="password" value="<?php echo $sales['password']; ?>" />
                                                </div>
                                            </div>
        ...
        $('#editProfileForm').on('submit', function(event) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    } else if (response === 'error_nomor_pengguna_exists') {
