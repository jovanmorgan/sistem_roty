                                    ...
                                    <table class="table table-hover text-center mt-3"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="white-space: nowrap;">Sudah dikemas</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success btn-sm" data-bs-toggle="modal"
                                                        data-bs-target="#batalkan<?php echo $row['id_dikemas']; ?>">Sudah
                                                        Dikemas & Kirimkan</button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="dibatalkanForm" method="POST"
                                                                ...
                                                                <input class="form-control" type="hidden" min="1"
                                                                    name="id_sales" id="id_sales"
                                                                    value="<?php echo $id_sales; ?>" required>
                                                                <div class="mb-3">
