...
<body translate="no">
    ...
    <main id="main" class="main">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class=" btn btn-warning btn-sm"
                                                                onclick="openEditModal('<?php echo $row['id_sales']; ?>','<?php echo $row['nama_lengkap']; ?>','<?php echo $row['nomor_hp']; ?>','<?php echo $row['nomor_pengguna']; ?>','<?php echo $row['password']; ?>')">Edit</button>
        ...
        <script>
            ...
            function openEditModal(id_sales, nama_lengkap, nomor_hp, nomor_pengguna, password) {
